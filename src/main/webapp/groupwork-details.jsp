		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse slimscrollsidebar">
				<ul class="nav" id="side-menu">
					...
					<li><a href="/crm_project/users" class="waves-effect"><i
							class="fa fa-user fa-fw" aria-hidden="true"></i><span
							class="hide-menu">Thành viên</span></a></li>
					<li><a href="/crm_project/roles" class="waves-effect"><i
							class="fa fa-modx fa-fw" aria-hidden="true"></i><span
							class="hide-menu">Quyền</span></a></li>
					<li><a href="/crm_project/groupwork" class="waves-effect"><i
							class="fa fa-table fa-fw" aria-hidden="true"></i><span
							class="hide-menu">Dự án</span></a></li>
					<li><a href="/crm_project/task" class="waves-effect"><i
							class="fa fa-table fa-fw" aria-hidden="true"></i><span
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="white-box">
								...
								<c:forEach var="task" items="${item.incompleteTask}">
						...
						<div class="col-md-4">
							<div class="white-box">
								...
								<c:forEach var="task" items="${item.inproccessTask}">
								<div class="message-center">
									<a href="#">
										<div class="mail-contnet">
											<h5>${task.name}</h5>
						...
						<div class="col-md-4">
							<div class="white-box">
								...
								<c:forEach var="task" items="${item.completedTask}">
								<div class="message-center">
									<a href="#">
										<div class="mail-contnet">
											<h5>${task.name}</h5>
