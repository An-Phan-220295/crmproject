...
public class UserRepository {
	...
	public int updateById(int id, String fullName, String userName, int roleId) {
		String query = "UPDATE Users SET fullName = ?,firstName = ?, lastName = ?,userName =?,id_role = ? WHERE id = ?";
		String[] splitString = fullName.split("\\s+");
		String firstName = splitString[splitString.length - 1];
		String lastName = splitString[0];
		int result = 0;
